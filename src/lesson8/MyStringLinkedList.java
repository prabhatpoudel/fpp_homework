...
public class MyStringLinkedList {
	...
	public static void main(String[] args) {
		...
		mySL.addLast("C");
		System.out.println(mySL);
		mySL.preAddNode(mySL.findItem("B"), "AA");
		System.out.println(mySL);
		mySL.postAddNode(mySL.findItem("B"), "BB");
		System.out.println(mySL);
		...
		/*
		 * System.out.println(mySL); mySL.printReverse(); mySL.addFront(
		 * "Carrot Cake"); System.out.println(mySL); mySL.printReverse();
		 * mySL.addFront("Blueberry Muffin"); System.out.println(mySL);
		 * mySL.printReverse(); mySL.addFront("Apple Pie");
		 * System.out.println(mySL); mySL.printReverse(); mySL.addLast(
		 * "Orange Juice"); System.out.println(mySL); mySL.printReverse();
		 * mySL.addLast("Peach Sauce"); System.out.println(mySL);
		 * mySL.printReverse(); mySL.deleteNode(mySL.findItem("Apple Pie"));
		 * System.out.println(mySL); mySL.printReverse();
		 ...
		 * System.out.println(mySL); mySL.printReverse(); mySL.deleteList();
		 * System.out.println(mySL); mySL.printReverse();
		 */
	}
